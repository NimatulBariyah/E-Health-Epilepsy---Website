        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a href="{{ url('/eeg') }}" class="btn btn-secondary">Kembali</a>
                </div>
            </div>  
        </div>
    </header>
                ...
                <div class="col-sm-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <h5 class="mb-2"><strong>Deskripsi EEG</strong></h5>
                            <p>{{ $eeg->description }}</p>
                        </div>
                    </div>
                    <div class="card mb-4">
                        <div class="card-body">
                            <h4 class="mb-4"><strong>Lampiran EEG</strong></h4>
                            <table class="table-borderless w-full">
                                @foreach($eeg->attachments as $i => $file)
                                <tr>
                                    <td>{{ ++$i }}. </td>
                                    <td>
